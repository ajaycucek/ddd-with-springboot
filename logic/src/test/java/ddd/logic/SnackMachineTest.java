...
import static ddd.logic.snackMachine.Snack.Chocolate;
...
public class SnackMachineTest {
	...
	public void inserted_money_goes_to_money_in_transaction() {
		...
		assertEquals(snackMachine.getMoneyInTransaction(), 1.01, 0.1);
	}
	...
	public void buySnack_trades_inserted_money_for_a_snack() {
		...
		assertEquals(snackMachine.getSnackPile(1).getQuantity(), 1);
	}
	...
	public void after_purchase_change_is_returned() {
		SnackMachine snackMachine = new SnackMachine();
		snackMachine.loadSnacks(1, new SnackPile(Chocolate, 1, 0.5f));
